...
const { Damage, Logger, ItemType, Stance, WeaponType } = require('ranvier');
...
class Combat {
   ...
   */
  static getWeaponDamage(attacker, total) {
    const weapon = this.findWeapon(attacker);
    ...
    state.WeaponManager.queryForWeaponDamage(baseWeapon, total);
